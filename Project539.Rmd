...
author: "Ololade Gbadebo"
output: html_document

---
<style>
p.caption {
    font-size: 0.95em; /* Adjust the font size as needed */
}
</style>

<style>
p.caption {
    color: black; /* Set the desired color (e.g., black) */
}
</style>
...
```
Aside the region, a difference in prevalence across countries may also be expected. To confirm this, the data was then analyzed to determine the number of cases per capita between January 1, 2020 and December 31, 2023. The data was capped that that time because upon manual overview of the data, some countries were without data after December 2023. The cumulative number of cases per per country was determined and divided by their respective populations. Cyprus had the highest prevalence, followed closely by San Marino (Figure 1). Belarus and Vatican have a least incidence which may be due to different factors including low reporting rate and limited surveillance.

```{r Cases per capita, echo = FALSE, message = FALSE, results='hide', fig.cap = "Figure 1. COVID-19 cases per capita in European countries. Data was sourced from Our World In Data and the coverage in this plot was January 2020 - December 2023.  Cyprus had the highest prevalence, followed closely by San Marino while it was least in Vatican.", fig.width = 10, fig.height = 8}
